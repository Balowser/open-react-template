...
const testimonials = [
  {
    ...
    name: "Klaus M.",
    company: "Vorsitzender Bürgerbus Musterstadt",
    content:
      "Endlich haben wir den Überblick! Keine vergessenen TÜV-Termine mehr.",
  ...
  },
  {
    ...
    company: "Disponentin",
    content:
      "Meine Oma ist 78 und kommt super damit zurecht. Das sagt alles!",
    categories: [1, 2, 3, 4, 5],
  },
  {
    ...
    name: "Werner K.",
    company: "Fahrdienstkoordinator",
    content:
      "Die Fahrereinteilung geht jetzt in 10 Minuten statt 2 Stunden.",
    categories: [1, 2, 3, 4, 5],
  },
  {
      ...
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          <p className="text-lg text-indigo-200/65">
            Vereine vertrauen auf BusLotse für ihre tägliche Organisation
          </p>
        </div>

        <div>
          {/* Buttons - Hidden for now */}
          <div className="flex justify-center pb-12 max-md:hidden md:pb-16" style={{ display: 'none' }}>
